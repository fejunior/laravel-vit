...
<template>
  <div>
    ...
    <div class="min-h-screen bg-gray-100">
      <nav class="bg-white border-transparent border-gray-100">
            ...
            <div class="flex  justify-between">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <NavLink
                  ...
                  :active="route().current('manangement.*')"
                >
                  Gestão
                </NavLink>
              </div>
                ...
                >
                  <template #trigger>
                    ...
                    <span class="inline-flex items-center rounded-md">
                      ...
                      >
                        <img
                          class=" h-12 w-12 rounded-full text-red-900 object-cover"
                          :src="$page.props.user.profile_photo_url"
                          :alt="$page.props.user.name"
                        >
                        <v-icon class="  text-gray-400 "> mdi-menu-down</v-icon>
